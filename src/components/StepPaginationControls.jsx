function StepPaginationControls({ currentStep, totalSteps, isLoading, canGoNext, onPrev, onNext, onSubmit }) {
  ...
  return (
    <div className="pagination-controls">
      ...
      <span className="pagination-controls__meta">Paso {currentStep} de {totalSteps}</span>
