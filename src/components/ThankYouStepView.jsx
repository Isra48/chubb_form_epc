function ThankYouStepView({ summary, onReset }) {
  return (
    <div className="thank-you">
      ...
      <p className="thank-you-lead">Tu información fue enviada correctamente, en breve nos pondremos en contacto contigo para coordinar la logística de tu viaje y tu asistencia  al evento.</p>
